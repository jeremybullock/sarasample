...
public:
  ...
  int getRealWebcamWidth() { return m_realWebcamWidth; }
  int getRealWebcamHeight() { return m_realWebcamHeight; }
  void setRealWebcamWidth(int width) { m_realWebcamWidth = width; }
  void setRealWebcamHeight(int height) { m_realWebcamHeight = height; }
...
private:
  ...
  int m_realWebcamWidth = 0;
  int m_realWebcamHeight = 0;
  bool m_useMjpg       = true;
  int m_colorMode      = 0;
  int m_white          = 255;
  int m_black          = 0;
